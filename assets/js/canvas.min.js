...
(function () {
  ...
  function K(h, l, v, w, ua) {
    w = w || [];
    ua = r(ua) ? (ib ? { passive: !1, capture: !1 } : !1) : ua;
    w.push([h, l, v, ua]);
    return h.addEventListener
      ? (h.addEventListener(l, v, ua), v)
      : h.attachEvent
      ? ((w = function (l) {
          l = l || window.event;
          l.preventDefault =
    ...
    w && bb
      ? ((wa =
          !r(wa) && wa
            ...
            : h.getContext("2d")),
        (Pa =
          wa.webkitBackingStorePixelRatio ||
          wa.mozBackingStorePixelRatio ||
          wa.msBackingStorePixelRatio ||
          wa.oBackingStorePixelRatio ||
          wa.backingStorePixelRatio ||
          1),
        (ka = Ta / Pa),
        (h.width = l * ka),
        (h.height = v * ka),
  ...
  function ra(h, l, v) {
    ...
    l.getAttribute("state") !== v &&
      ...
      (l.innerHTML =
        ...
        "' />"),
      T(l.childNodes[0], { height: "95%", pointerEvents: "none" }));
  ...
  function Ua(h, l, v, r, w) {
    ...
    "undefined" !== typeof r &&
      ((h = Math.min(r, h)), "undefined" !== typeof w && (h = Math.max(w, h)));
    return !isNaN(h) && h <= l && 0 <= h ? h : "undefined" === typeof v ? l : v;
  }
  function Z(h, l, v, w, x) {
    this._defaultsKey = h;
    ...
    h = {};
    this.theme && r(this.parent) && r(l) && r(w)
  ...
  function Ba(h, l) {
    ...
    if (r(this.options.margin) && h.options.subtitles)
      for (var v = h.options.subtitles, w = 0; w < v.length; w++)
        if (
          ((r(v[w].horizontalAlign) && "center" === this.horizontalAlign) ||
            v[w].horizontalAlign === this.horizontalAlign) &&
          ((r(v[w].verticalAlign) && "top" === this.verticalAlign) ||
  ...
  (function () {
    ...
    Y.pro = { sCH: pa[Y.fSDec("Bi`su")][Y.fSDec("bsdehuIsdg")] };
    Y._fTWm = function (h) {
      if ("undefined" === typeof Y.pro.sCH && !eb)
        try {
          var l,
            v = h[Y.fSDec("buy")];
          ...
          v[Y.fSDec("bmd`sSdbu")](
            0,
            l,
            v[Y.fSDec("ld`rtsdUdyu")](Y.fSDec("B`ow`rKR!Ush`m")).width,
            11
          );
  ...
  var ib = (function () {
        ...
        return (P = I.replace(h, function (m) {
          switch (m) {
            ...
            case "K":
              return Y
                ? "UTC"
                : (String(E).match(x) || [""]).pop().replace(D, "");
            case "z":
        ...
        if (((l = E[O]), "." === l && 0 > I)) I = O;
          ...
          if ("%" === l) D *= 100;
            ...
            ("E" !== l[0] && "e" !== l[0]) ||
              ...
              (Y = !0);
          0 > I
            ? (P.push(l), "#" === l || "0" === l ? S++ : "," === l && J++)
            : (L.push(l), ("#" !== l && "0" !== l) || K++);
        }
      Y &&
        ((l = Math.floor(h)),
        (E = -Math.floor(Math.log(h) / Math.LN10 + 1)),
        (T = 0 === h ? 0 : 0 === l ? -(S + E) : pb(l).length - S),
        (D /= Math.pow(10, T)));
      0 > I && (I = O);
      D = (h * D).toFixed(K);
      l = D.split(".");
        ...
        if (((l = P.pop()), "#" === l || "0" === l))
          if ((I++, I === S)) {
            ...
            for (; 0 < $.length; )
              (v = $.pop() + v),
                Y++,
                0 === Y % E && O === J && 0 < $.length && (v = x + v);
          } else
            0 < D.length
              ? ((v = D.pop() + v), K++, Y++)
              : "0" === l && ((v = "0" + v), K++, Y++),
              0 === Y % E && O === J && 0 < D.length && (v = x + v);
        else
          ("E" !== l[0] && "e" !== l[0]) ||
          "0" !== l[l.length - 1] ||
          !/[eE][+-]*[0]+/.test(l)
            ? "," === l
              ? (O++, (E = Y), (Y = 0), 0 < D.length && (v = x + v))
              : (v =
                  1 < l.length &&
                  (('"' === l[0] && '"' === l[l.length - 1]) ||
                    ("'" === l[0] && "'" === l[l.length - 1]))
    ...
    Qa = function (h) {
      ...
      h.offsetX || 0 === h.offsetX
        ? ((l = h.offsetX), (r = h.offsetY))
        : h.layerX || 0 == h.layerX
        ? ((l = h.layerX), (r = h.layerY))
    ...
    ea = function (h, l, r, w, x, E, D, I, S, P, L, Y, K) {
      ...
      0 < D &&
        ...
        (h.strokeStyle = I),
        h.moveTo(l, r),
        h.rect(l - K, r - K, w - l + 2 * K, x - r + 2 * K),
        h.stroke());
      h.restore();
      !0 === S &&
        (h.save(),
        ...
        h.lineTo(w, r),
        h.closePath(),
        (D = h.createLinearGradient((w + l) / 2, r + J, (w + l) / 2, r)),
        D.addColorStop(0, E),
      ...
      !0 === P &&
        ...
        h.lineTo(w, x),
        h.closePath(),
        (D = h.createLinearGradient((w + l) / 2, x - J, (w + l) / 2, x)),
        D.addColorStop(0, E),
        D.addColorStop(1, "rgba(255, 255, 255, .4)"),
        (h.fillStyle = D),
        h.fill(),
      ...
      !0 === L &&
        ...
        h.lineTo(l, x),
        h.closePath(),
        (D = h.createLinearGradient(l + J, (x + r) / 2, l, (x + r) / 2)),
        D.addColorStop(0, E),
      ...
      !0 === Y &&
        ...
        h.lineTo(w - J, x - J),
        h.lineTo(w, x),
        (D = h.createLinearGradient(w - J, (x + r) / 2, w, (x + r) / 2)),
        D.addColorStop(0, E),
        D.addColorStop(1, "rgba(255, 255, 255, 0.1)"),
        (h.fillStyle = D),
        D.addColorStop(0, E),
  ...
  Z.prototype.setOptions = function (h, l) {
    if (pa[this._defaultsKey]) {
      ...
      for (w in r)
        "publicProperties" !== w &&
          r.hasOwnProperty(w) &&
          (this[w] = h && w in h ? h[w] : l && w in l ? l[w] : r[w]);
      ...
      : this.parent &&
        ...
        (null === I
          ...
          : 0 < this.parent.themeOptions[E].length &&
            ((w = Math.min(this.parent.themeOptions[E].length - 1, I)),
            (w = this.parent.themeOptions[E][w])));
    this.themeOptions = w;
    h in l &&
      (x = h in this.options ? this.options[h] : w && h in w ? w[h] : l[h]);
  ...
  Z.prototype.addEventListener = function (h, l, r) {
    h &&
      ...
      this._eventListeners[h].push({ context: r || this, eventHandler: l }));
  };
  ...
  Z.prototype.dispatchEvent = function (h, l, r) {
    if (h && this._eventListeners[h]) {
      ...
      for (var w = this._eventListeners[h], x = 0; x < w.length; x++)
        w[x].eventHandler.call(w[x].context, l);
    }
  ...
  ja.prototype._wrapText = function () {
    ...
    this._wrappedText = { lines: l, width: x, height: w };
  ...
  Ba.prototype.setLayout = function () {
    if (this.text) {
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? (null === this.maxWidth &&
            (this.maxWidth =
              l.width - 4 - D * ("center" === this.horizontalAlign ? 2 : 1)),
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? ("top" === this.verticalAlign
            ...
            : "bottom" === this.verticalAlign &&
              ((x = l.y2 - 2 - P.height), (K = "bottom")),
          "left" === this.horizontalAlign
            ? (w = l.x1 + 2)
            : "center" === this.horizontalAlign
            ? (w = l.x1 + l.width / 2 - P.width / 2)
            : "right" === this.horizontalAlign && (w = l.x2 - 2 - P.width - D),
        ...
        : "center" === this.verticalAlign &&
          ("left" === this.horizontalAlign
            ? ((w = l.x1 + 2),
              (x = l.y2 - 2 - (this.maxWidth / 2 - P.width / 2)),
              (E = -90),
              (K = "left"),
              (this.width = P.height),
              (this.height = P.width))
            ...
            ? ((w = l.x2 - 2),
              (x = l.y1 + 2 + (this.maxWidth / 2 - P.width / 2)),
              (E = 90),
              (K = "right"),
              (this.width = P.height),
              (this.height = P.width))
            : "center" === this.horizontalAlign &&
              ((x = h.y1 + (h.height / 2 - P.height / 2)),
  ...
  x = Ra.Chart = (function () {
      ...
      if (this.options.zoomEnabled || this.panEnabled) {
          ...
          K(
            ...
            function () {
              a.zoomEnabled
                ? ((a.zoomEnabled = !1),
                  (a.panEnabled = !0),
                  ra(a, a._zoomButton, "zoom"))
                : ((a.zoomEnabled = !0),
                  (a.panEnabled = !1),
                  ra(a, a._zoomButton, "pan"));
              a.render();
            },
            this.allDOMEventHandlers
          );
        ...
        this._resetButton
          ...
          : ((d = !1),
            ...
            ra(this, this._resetButton, "reset"),
    ...
    l.prototype.setLayout = function () {
      ...
      if (this.options.subtitles)
        for (d = 0; d < this.options.subtitles.length; d++)
          (c = new Ka(this, this.options.subtitles[d], d)),
      ...
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
        for (
          ...
          if ("normal" === p.axisPlacement || "xySwapped" === p.axisPlacement)
            var Aa = a.axisX.sessionVariables.newViewportMinimum
                ? a.axisX.sessionVariables.newViewportMinimum
                : a.axisX.options && a.axisX.options.viewportMinimum
                ? a.axisX.options.viewportMinimum
                : a.axisX.options && a.axisX.options.minimum
    ...
    l.prototype.renderIndexLabels = function (a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        var n = this._indexLabels[a],
          ...
          q,
          g,
          m = la("indexLabelFontColor", n.dataPoint, n.dataSeries),
        ...
        var l = la("indexLabelLineDashType", n.dataPoint, n.dataSeries),
          ...
          A = r(n.dataPoint.indexLabelLineThickness)
        ...
        if (
          ...
          y = this.getPercentAndTotal(n.dataSeries, n.dataPoint);
        ...
        var F = n.dataPoint.indexLabelFormatter
        ...
        if (null !== F && "" !== F) {
          ...
          if ("normal" === this.plotInfo.axisPlacement) {
            ...
            "inside" !== y
              ? ((e = c.y1),
                ...
                0 < v
                  ? ((g =
                      n.point.y + ("horizontal" === z ? s / 2 : 0) - k - u - b),
                    g < e &&
                      ((g =
                        "auto" === y
                          ? Math.max(n.point.y, e) + s / 2 + u
                          : e + s / 2 + u),
                      (x = g + k > n.point.y)))
                  : ((g = n.point.y + s / 2 + u + b),
                    g > f - k &&
              ...
              : ((e = Math.max(n.bounds.y1, c.y1)),
                ...
                (b =
                  0 <= p.indexOf("range") || "error" === p
                    ? 0 < v
                      ? Math.max(n.bounds.y1, c.y1) + s / 2 + u
                      : Math.min(n.bounds.y2, c.y2) + s / 2 - k + u
              ...
              "inside" !== y
                ? ((e = c.x1),
                  ...
                  0 > v
                    ? ((q =
                      ...
                      q < e &&
                        ((q =
                          "auto" === y ? Math.max(n.point.x, e) + m : e + m),
                        (x = q + C > n.point.x)))
                    : ((q =
                        n.point.x + ("horizontal" === z ? 0 : s / 2) + m + b),
                      q > f - C - m - b &&
                        ((q =
                          "auto" === y
                ...
                : ((e = Math.max(n.bounds.x1, c.x1)),
                  ...
                  (b =
                    0 <= p.indexOf("range") || "error" === p
                      ? 0 > v
                        ? Math.max(n.bounds.x1, c.x1) + s / 2 + m
                        : Math.min(n.bounds.x2, c.x2) -
                          C / 2 -
                          m +
                          ("horizontal" === z ? 0 : s / 2)
          ...
          A &&
            ...
            d.setLineDash && d.setLineDash(I(l, A)),
            d.beginPath(),
        ...
        for (var f = [], m, u = 0; u < a.dataSeriesIndexes.length; u++) {
          ...
          if (0 < n.length) {
            for (var z = !1, t = 0; t < n.length; t++)
              if (
                ((r = n[t].x.getTime ? n[t].x.getTime() : n[t].x),
                !(
                ...
                if ("number" !== typeof n[t].y)
                  ...
                  l || z
                    ...
                    : (c.lineTo(r, y),
                      ...
                      0 == t % 500 &&
                        ...
                        c.beginPath(),
                        c.moveTo(r, y),
                        w && (b.stroke(), b.beginPath(), b.moveTo(r, y))));
                  m = { x: r, y: y };
                  t < n.length - 1 &&
                    (h !== (n[t].lineColor || s) ||
                  ...
                  if (
                    ...
                    var B = k.getMarkerProperties(t, r, y, c);
                    f.push(B);
                    F = S(F);
                    w &&
                      f.push({
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var f = [], m, u = 0; u < a.dataSeriesIndexes.length; u++) {
          ...
          if (0 < n.length) {
            for (var z = !1, t = 0; t < n.length; t++)
              if (
                ((r = n[t].getTime ? n[t].x.getTime() : n[t].x),
                !(
                  r < a.axisX.dataInfo.viewPortMin ||
                  (r > a.axisX.dataInfo.viewPortMax &&
                    (!k.connectNullData || !z))
                ...
                if ("number" !== typeof n[t].y)
                  ...
                  0 !== n[t].markerSize &&
                    (0 < n[t].markerSize || 0 < k.markerSize) &&
                    ((F = k.getMarkerProperties(t, r, y, c)),
                    f.push(F),
                    (B = S(B)),
                    w &&
                      f.push({
            ...
            for (r = !1, l = 0; l < n.length; l++)
              if (
                ...
                if ("number" !== typeof n[l].y)
                  0 < l &&
                    ...
                    (k.connectNullData
                      ? b.setLineDash &&
                        ...
                        (k.options.nullDataLineDashType ||
                          !n[l - 1].lineDashType) &&
                        ((y[y.length - 1].newLineDashArray = q),
                        (p = k.nullDataLineDashType))
                      : (d(y), (y = []))),
                    (r = !0);
                else {
                  ...
                  if (
                    0 !== n[l].markerSize &&
                    (0 < n[l].markerSize || 0 < k.markerSize)
                  ) {
            ...
            for (k = 0; k < t.length; k++)
              if (
                ...
                ea(
                  ...
                  0,
                  null,
                  r && (a.axisY.reversed ? 0 > t[k].y : 0 <= t[k].y),
                  (a.axisY.reversed ? 0 <= t[k].y : 0 > t[k].y) && r,
                  !1,
                  !1,
                  l.fillOpacity
                );
    ...
    l.prototype.renderStackedColumn100 = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (g = 0; g < a.dataSeriesIndexes.length; g++) {
          ...
          if (0 < t.length)
            for (
              var r = 5 < s && l.bevelEnabled ? !0 : !1, k = 0;
              k < t.length;
              k++
            )
              if (
            ...
            for (k = 0; k < t.length; k++)
              if (
                ...
                if (
                  ...
                  (C[b] = y + (C[b] ? C[b] : 0)),
                    (n = m[b] ? m[b] : q),
                    (m[b] = y = a.axisY.convertValueToPixel(C[b]));
                ...
                ea(
                  c,
                  a.axisY.reversed ? n : y,
                  p,
                  a.axisY.reversed ? y : n,
                  z,
                  b,
                  0,
                  null,
    ...
    l.prototype.renderArea = function (a) {
      ...
      function b() {
        F &&
          ...
          f.fill(),
          (f.globalAlpha = 1),
          w && (m.lineTo(l, z), m.lineTo(F.x, z), m.closePath(), m.fill()),
          f.beginPath(),
          f.moveTo(l, t),
          m.beginPath(),
          m.moveTo(l, t),
        ...
        for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
          ...
          if (0 < s.length) {
            ...
            for (var fa = !0; h < s.length; h++)
              if (
                ((r = s[h].x.getTime ? s[h].x.getTime() : s[h].x),
                !(
                  r < a.axisX.dataInfo.viewPortMin ||
                  (r > a.axisX.dataInfo.viewPortMax &&
                ...
                if ("number" !== typeof s[h].y)
                  ...
                  0 !== s[h].markerSize &&
                    ...
                    ((r = g.getMarkerProperties(h, l, t, f)),
                    C.push(r),
                    (aa = S(aa)),
                    w &&
                      C.push({
              ...
              if (
                ...
                if ("number" !== typeof p[q].y)
                    ...
                    (n.connectNullData
                      ? b.setLineDash &&
                        ...
                        (n.options.nullDataLineDashType ||
                          !p[q - 1].lineDashType) &&
                        ((A[A.length - 1].newLineDashArray = x),
                  ...
                  q < p.length - 1 &&
                    ...
                    ((F = p[q].lineColor || z),
                    (A[A.length - 1].newStrokeStyle = F),
                    b.setLineDash &&
                      (p[q].lineDashType
                        ? ((B = p[q].lineDashType),
                          (A[A.length - 1].newLineDashArray = I(
                            B,
                            n.lineThickness
                          )))
                        : ((B = n.lineDashType),
                          (A[A.length - 1].newLineDashArray = D))));
                  if (
                    0 !== p[q].markerSize &&
    ...
    l.prototype.renderStepArea = function (a) {
      ...
      function b() {
        F &&
          ...
          f.fill(),
          (f.globalAlpha = 1),
          w && (m.lineTo(r, z), m.lineTo(F.x, z), m.closePath(), m.fill()),
          f.beginPath(),
          f.moveTo(r, t),
          m.beginPath(),
          m.moveTo(r, t),
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
          ...
          if (0 < s.length) {
            ...
            for (; l < s.length; l++)
              if (
                ((A = s[l].x.getTime ? s[l].x.getTime() : s[l].x),
                !(
                ...
                "number" !== typeof s[l].y
                  ...
                  : ((r = a.axisX.convertValueToPixel(A)),
                    (t = a.axisY.convertValueToPixel(s[l].y)),
                    d || c
                      ? (!d && g.connectNullData
                          ? (f.setLineDash &&
                              (g.options.nullDataLineDashType ||
                              ...
                              (t = c),
                              (F = n),
                              (N = g.nullDataLineDashType),
                              f.setLineDash(Q)),
                            f.lineTo(r, aa),
                            f.lineTo(r, t),
                            w && (m.lineTo(r, aa), m.lineTo(r, t)))
                          : (f.beginPath(),
                            f.moveTo(r, t),
                            w && (m.beginPath(), m.moveTo(r, t)),
                            (F = { x: r, y: t })),
                        (c = d = !1))
                      : (f.lineTo(r, aa),
                        w && m.lineTo(r, aa),
                    ...
                    l < s.length - 1 &&
                      (x !== (s[l].lineColor || v) ||
                        N !== (s[l].lineDashType || g.lineDashType)) &&
                      (b(),
                      (x = s[l].lineColor || v),
                      (f.strokeStyle = x),
                      f.setLineDash &&
                        (s[l].lineDashType
                          ? ((N = s[l].lineDashType),
                            f.setLineDash(I(N, g.lineThickness)))
                          : ((N = g.lineDashType), f.setLineDash(D)))),
                    (A = g.dataPointIds[l]),
                    ...
                    0 !== s[l].markerSize &&
                      (0 < s[l].markerSize || 0 < g.markerSize) &&
                      ((aa = g.getMarkerProperties(l, r, t, f)),
                      h.push(aa),
                      (A = S(A)),
                      w &&
                        h.push({
    ...
    l.prototype.renderStackedArea = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var e = [], z = 0; z < a.dataSeriesIndexes.length; z++) {
          var F = a.dataSeriesIndexes[z],
            B = this.data[F],
            v = B.dataPoints;
          B.dataPointIndexes = [];
          for (q = 0; q < v.length; q++)
            (F = v[q].x.getTime ? v[q].x.getTime() : v[q].x),
              (B.dataPointIndexes[F] = q),
              e[F] || (n.push(F), (e[F] = !0));
          n.sort(Sa);
        }
            ...
            for (var aa = !0, q = 0; q < n.length; q++) {
              ...
              if (
                ...
                if ("number" !== typeof ga.y)
                  ...
                  q < v.length - 1 &&
                    (N !== (v[q].lineColor || x) ||
                      y !== (v[q].lineDashType || B.lineDashType)) &&
                    (d(),
                    b.beginPath(),
                    b.moveTo(g, s),
                    k.push({ x: g, y: l - ma }),
                    ...
                    b.setLineDash &&
                      (v[q].lineDashType
                        ? ((y = v[q].lineDashType),
                          b.setLineDash(I(y, B.lineThickness)))
                        : ((y = B.lineDashType), b.setLineDash(D))));
    ...
    l.prototype.renderStackedArea100 = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        b.clip();
        w && (y.beginPath(), y.rect(m.x1, m.y1, m.width, m.height), y.clip());
        for (var e = [], z = 0; z < a.dataSeriesIndexes.length; z++) {
            ...
            for (var aa = !0, q = 0; q < n.length; q++) {
              ...
              if (
                ...
                if ("number" !== typeof ga.y)
                  ...
                  q < x.length - 1 &&
                    (N !== (x[q].lineColor || D) ||
                      t !== (x[q].lineDashType || B.lineDashType)) &&
                    (d(),
                    b.beginPath(),
                    b.moveTo(g, s),
                    k.push({ x: g, y: A - ba }),
                    ...
                    b.setLineDash &&
                      (x[q].lineDashType
                        ? ((t = x[q].lineDashType),
                          b.setLineDash(I(t, B.lineThickness)))
                        : ((t = B.lineDashType), b.setLineDash(E))));
                  if (0 <= B.dataPointIndexes[f]) {
                  ...
                  0 <= B.dataPointIndexes[f] &&
                    0 !== ga.markerSize &&
                    (0 < ga.markerSize || 0 < B.markerSize) &&
                    ((ba = B.getMarkerProperties(q, g, s, b)),
                    u.push(ba),
                    (f = S(G)),
                    w &&
                      u.push({
    ...
    l.prototype.renderCandlestick = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
          ...
          if (0 < A.length)
            for (
              var y = 5 < s && t.bevelEnabled ? !0 : !1, u = 0;
              u < A.length;
              u++
            )
              if (
                (A[u].getTime ? (g = A[u].x.getTime()) : (g = A[u].x),
                !(
                  g < a.axisX.dataInfo.viewPortMin ||
                  g > a.axisX.dataInfo.viewPortMax
                ) &&
                  !r(A[u].y) &&
                  A[u].y.length &&
                  "number" === typeof A[u].y[0] &&
                  "number" === typeof A[u].y[1] &&
                  "number" === typeof A[u].y[2] &&
                  "number" === typeof A[u].y[3])
              ) {
                ...
                "candlestick" === t.type
                  ? (c.moveTo(h - x, n),
                    ...
                    ea(
                      ...
                      v,
                      Math.max(k, q),
                      A[u].y[0] <= A[u].y[3] ? t.risingColor : f,
                      B,
                      e,
                      y,
                      y,
                ...
                (A[u].indexLabel ||
                  t.indexLabel ||
                  A[u].indexLabelFormatter ||
                  t.indexLabelFormatter) &&
                  this._indexLabels.push({
                    chartType: t.type,
                    dataPoint: A[u],
                    dataSeries: t,
                    point: { x: z + (v - z) / 2, y: a.axisY.reversed ? p : n },
                    direction: 1,
                    bounds: {
                      x1: z,
                      y1: Math.min(n, p),
    ...
    l.prototype.renderBoxAndWhisker = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (
          var l = !1, l = !!a.axisY.reversed, Aa = 0;
          Aa < a.dataSeriesIndexes.length;
          Aa++
        ) {
          ...
          if (0 < y.length)
            for (
              var z = 5 < s && A.bevelEnabled ? !0 : !1, m = 0;
              m < y.length;
              m++
            )
              if (
                (y[m].getTime ? (g = y[m].x.getTime()) : (g = y[m].x),
                !(
                  g < a.axisX.dataInfo.viewPortMin ||
                  g > a.axisX.dataInfo.viewPortMax
                ) &&
                  ...
                  "number" === typeof y[m].y[2] &&
                  "number" === typeof y[m].y[3] &&
                  "number" === typeof y[m].y[4] &&
                  5 === y[m].y.length)
              ) {
                ...
                var v = (u - s / 2) << 0,
                  ...
                  N = y[m].whiskerColor
                    ...
                    : e,
                  Q =
                    "number" === typeof y[m].whiskerThickness
                      ? y[m].whiskerThickness
                      : "number" === typeof A.options.whiskerThickness
                      ? A.whiskerThickness
                      : x,
                  E = y[m].whiskerDashType
                    ? y[m].whiskerDashType
                    : A.whiskerDashType,
                  aa = r(y[m].whiskerLength)
                    ? r(A.options.whiskerLength)
                      ? s
                      : A.whiskerLength
                    : y[m].whiskerLength,
                  aa =
                  ...
                  ma = y[m].stemColor
                    ...
                    : e,
                  ba =
                    "number" === typeof y[m].stemThickness
                      ? y[m].stemThickness
                      : "number" === typeof A.options.stemThickness
                      ? A.stemThickness
                      : x,
                  G = 1 === Math.round(ba) % 2 ? 0.5 : 0,
                  J = y[m].stemDashType ? y[m].stemDashType : A.stemDashType,
                  K = y[m].lineColor
                    ? y[m].lineColor
                    : y[m].color
                    ? A.lineColor
                    ...
                    : e,
                  L =
                    "number" === typeof y[m].lineThickness
                      ? y[m].lineThickness
                      : "number" === typeof A.options.lineThickness
                      ? A.lineThickness
                      : x,
                ...
                0 < ba &&
                  ...
                  (c.strokeStyle = ma),
                  (c.lineWidth = ba),
                  c.setLineDash && c.setLineDash(I(J, ba)),
                  c.moveTo(u - G, k),
                  c.lineTo(u - G, h),
                  c.stroke(),
                  c.moveTo(u - G, p),
                ...
                0 < L &&
                  (c.beginPath(),
                  (c.globalAlpha = 1),
                  c.setLineDash && c.setLineDash(I(P, L)),
                  (c.strokeStyle = K),
                  (c.lineWidth = L),
                  c.moveTo(v, q - M),
                  c.lineTo(B, q - M),
                ...
                0 < Q &&
                  (c.beginPath(),
                  c.setLineDash && c.setLineDash(I(E, Q)),
                  (c.strokeStyle = N),
                  (c.lineWidth = Q),
                  c.moveTo((u - aa / 2) << 0, p - ga),
                  c.lineTo((u + aa / 2) << 0, p - ga),
                  c.stroke(),
                  c.moveTo((u - aa / 2) << 0, h + ga),
                  c.lineTo((u + aa / 2) << 0, h + ga),
                  c.stroke());
                c.restore();
                w &&
                  ((e = S(R)),
                  ...
                  0 < Q &&
                    (b.beginPath(),
                    (b.lineWidth = Q),
                    b.moveTo(u + aa / 2, p - ga),
                    b.lineTo(u - aa / 2, p - ga),
                    b.stroke(),
                    b.moveTo(u + aa / 2, h + ga),
                    b.lineTo(u - aa / 2, h + ga),
                    b.stroke()));
                (y[m].indexLabel ||
                  A.indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    dataPoint: y[m],
                    dataSeries: A,
                    point: { x: v + (B - v) / 2, y: a.axisY.reversed ? h : p },
                    direction: 1,
                    bounds: {
                      x1: v,
                      y1: Math.min(h, p),
          ...
          if (0 < F.length)
            for (var E = z._colorSet, u = 0; u < F.length; u++) {
              var e = (z.lineColor = z.options.color ? z.options.color : E[0]),
                N = {
                  color: F[u].whiskerColor
                    ...
                    ? z.whiskerColor
                    : e,
                  thickness: r(F[u].whiskerThickness)
                    ? z.whiskerThickness
                    : F[u].whiskerThickness,
                  dashType: F[u].whiskerDashType
                    ? F[u].whiskerDashType
                    : z.whiskerDashType,
                  length: r(F[u].whiskerLength)
                    ? r(z.options.whiskerLength)
                      ? t
                      : z.options.whiskerLength
                    : F[u].whiskerLength,
                  trimLength: r(F[u].whiskerLength)
                    ? r(z.options.whiskerLength)
                      ? 50
                      : 0
                    : 0,
              ...
              if (
                ...
                b
                  ? ((q = a.axisX.reversed
                      ? (k + ((B ? v : 1) * t) / 2 - (B ? D - 1 : 0) * t) << 0
                      : (k - ((B ? v : 1) * t) / 2 + (B ? D - 1 : 0) * t) << 0),
                    (g = a.axisX.reversed ? (q - t) << 0 : (q + t) << 0))
                  : ((n = a.axisX.reversed
                      ? (h + ((B ? v : 1) * t) / 2 - (B ? D - 1 : 0) * t) << 0
                      : (h - ((B ? v : 1) * t) / 2 + (B ? D - 1 : 0) * t) << 0),
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var u = 0; u < a.dataSeriesIndexes.length; u++) {
          ...
          if (0 < p.length) {
            ...
            var B = "solid";
            if (b.setLineDash) {
              var D = I(n.nullDataLineDashType, n.lineThickness),
                B = n.lineDashType,
                  ...
                  p < n.length - 1 &&
                    ...
                    b.setLineDash &&
                      (n[p].lineDashType
                        ...
                        : ((z = k.lineDashType),
                          (r[r.length - 1].newLineDashArray = F))));
                  if (
                    0 !== n[p].markerSize &&
        ...
        for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
          ...
          var t =
              "number" === typeof r.options.lineThickness
                ...
                : 1,
            A = 1 === Math.round(t) % 2 ? -0.5 : 0;
          if (0 < v.length)
            for (
              var y = 5 < q && r.bevelEnabled ? !0 : !1,
                z = !1,
                x = null,
                B = null,
                m = 0;
              ...
              if (
                ...
                if (0 < m && !z && r.connectNullData)
                  var D =
                    r.options.nullDataLineDashType || !v[m - 1].lineDashType
                ...
                l =
                  0 === r.dataPointEOs[m].cumulativeSum
                    ? p
                    : a.axisY.convertValueToPixel(
                        r.dataPointEOs[m].cumulativeSum
                      );
                k =
                  0 === r.dataPointEOs[m].cumulativeSumYStartValue
                    ? p
                    : a.axisY.convertValueToPixel(
                        r.dataPointEOs[m].cumulativeSumYStartValue
                      );
                h = a.axisX.reversed
                  ? (h +
                ...
                0 < m &&
                  x &&
                  (!z || r.connectNullData) &&
                  (z && c.setLineDash && c.setLineDash(I(D, t)),
                  c.beginPath(),
                  c.moveTo(x, B - A),
                  c.lineTo(N, Q - A),
                  0 < t && c.stroke(),
    ...
    l.prototype.renderPie = function (a) {
      ...
      function c(a) {
        ...
        for (b = 0; b < n.length; b++) {
          ...
          if (d > c) {
            ...
            if (n[b].exploded) {
              if (
                1e-9 < Math.abs(g[b].center.x - (y.x + e)) ||
                1e-9 < Math.abs(g[b].center.y - (y.y + f))
              )
                (g[b].center.x = y.x + e * a),
                  (g[b].center.y = y.y + f * a),
                  (m = !0);
            } else if (
              0 < Math.abs(g[b].center.x - y.x) ||
              0 < Math.abs(g[b].center.y - y.y)
            )
              (g[b].center.x = y.x + e * (1 - a)),
      ...
      function f(a, c, d) {
        ...
        if (0 <= a && a < n.length) {
          ...
          k =
            "right" === p.hemisphere
              ? y.x + Math.sqrt(Math.pow(w, 2) - Math.pow(c - y.y, 2))
              : y.x - Math.sqrt(Math.pow(w, 2) - Math.pow(c - y.y, 2));
          ...
          m &&
            ...
            (c =
              "right" === p.hemisphere
                ? y.x + Math.sqrt(Math.pow(w, 2) - Math.pow(d - y.y, 2))
                : y.x - Math.sqrt(Math.pow(w, 2) - Math.pow(d - y.y, 2))),
            ...
            (p.indexLabelAngle = Math.atan2(
              p.indexLabelTextBlock.y - y.y,
              p.indexLabelTextBlock.x - y.x
            )));
        }
        return m;
      }
            ...
            for (var u, r, a = 0; a < n.length; a++) {
              ...
              if (null !== t) {
                ...
                var z = 0,
                  z = b(u, r) - s;
                if (0 > z) {
                  for (var x = (r = 0), F = 0; F < n.length; F++)
                    F !== a &&
                  ...
                  "right" === h.hemisphere
                    ? ((F = f(a, r)),
                      (x = -1 * (z - F)),
                      (I = f(t, x)),
                      +I.toFixed(A) < +x.toFixed(A) &&
                        +F.toFixed(A) <= +r.toFixed(A) &&
                        f(a, -(x - I)))
                    : ((F = f(t, r)),
                      (x = -1 * (z - F)),
                      (I = f(a, x)),
                  ...
                  (!m &&
                    ...
                    ((r =
                      0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI
                        ...
                        : 1),
                    0 === f(a, t * r) && f(a, 2 * r)),
                  Math.abs(h.indexLabelTextBlock.x - y.x) < B &&
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var x = 0; x < n.length; x++)
          (z += Math.abs(n[x].y)),
            !a &&
              "undefined" !== typeof n[x].indexLabel &&
              null !== n[x].indexLabel &&
              0 < n[x].indexLabel.toString().length &&
              (a = !0),
            !a &&
              "undefined" !== typeof n[x].label &&
              null !== n[x].label &&
              0 < n[x].label.toString().length &&
              (a = !0);
        if (0 !== z) {
          a =
            a ||
    ...
    l.prototype.renderFunnel = function (a) {
      function d() {
        ...
        if (0 === a) return -1;
        for (c = b[0] = 0; c < A.length; c++)
          b.push((Math.abs(A[c].y) * E) / a);
        return b;
      }
      function c() {
        var a = W,
        ...
        if (t && A) {
          ...
          for (var B = 0, D = A.length - 1; B < A.length || 0 <= D; B++, D--) {
            ...
            a = b.color
              ? b.color
              : t.reversed
              ? t._colorSet[(A.length - 1 - B) % t._colorSet.length]
              : t._colorSet[B % t._colorSet.length];
            ...
            b = b.indexLabelFormatter
              ...
              : b.indexLabel
              ? x.replaceKeywordsWithValue(b.indexLabel, b, t, B)
              : t.indexLabelFormatter
              ? t.indexLabelFormatter(z)
              : t.indexLabel
              ? x.replaceKeywordsWithValue(t.indexLabel, b, t, B)
              : b.label
              ? b.label
              : "";
            0 >= n && (n = 0);
        ...
        if (e)
          for (m = H.length - 1; 0 <= m; m--)
            (a = R[m]),
              ...
              t.reversed
                ? (H[m].textBlock.y + H[m].height > na + z &&
                    (H[m].textBlock.y = na + z - H[m].height),
                  H[m].textBlock.y < sa - z && (H[m].textBlock.y = sa - z))
                : (H[m].textBlock.y < na - z && (H[m].textBlock.y = na - z),
                  H[m].textBlock.y + H[m].height > sa + z &&
                    (H[m].textBlock.y = sa + z - H[m].height));
      }
      function f() {
        var a, b, c, d;
          ...
          for (var e = 0; e < R.length; e++)
            0 == H[e].textBlock.text.length
              ...
              : ((a = R[e]),
                ...
                t.reversed
                  ? (H[e].textBlock.y + H[e].height > na + z &&
                      (H[e].textBlock.y = na + z - H[e].height),
                    H[e].textBlock.y < sa - z && (H[e].textBlock.y = sa - z))
                  : (H[e].textBlock.y < na - z && (H[e].textBlock.y = na - z),
                    H[e].textBlock.y + H[e].height > sa + z &&
                      (H[e].textBlock.y = sa + z - H[e].height)));
        else
      ...
      function m() {
        ...
        for (var d, e, f, g, m, k, n = 1, l = 0; l < 2 * n; l++) {
          for (
            ...
            (f = H[s]),
            (g = f.textBlock),
            (k = (m = q(s) < R.length ? H[q(s)] : null) ? m.textBlock : null),
      ...
      function h(a, b) {
        return (
          (b < R.length ? H[b].textBlock.y : t.reversed ? na + z : sa + z) -
          (0 > a
            ? t.reversed
              ? sa - z
              : na - z
      ...
      function l(a, b, c) {
        ...
        if (0 === X.length) m = ia;
          ...
          for (var q = 0; q < R.length; q++) {
            ...
            m.push(ia[q] + d);
            if (0 <= X.indexOf(q) || (q < R.length && 0 <= X.indexOf(q + 1)))
              d += e;
          }
        }
        g = (function () {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        for (
          var t = this.data[a.dataSeriesIndexes[0]],
            ...
            B = 0,
            E = y.height - 2 * z,
            J = Math.min(y.width - 2 * D, 2.8 * y.height),
            N = !1,
            Q = 0;
          Q < A.length;
          Q++
          ...
          if (
            (!N &&
              "undefined" !== typeof A[Q].indexLabel &&
              null !== A[Q].indexLabel &&
              0 < A[Q].indexLabel.toString().length &&
              (N = !0),
            !N &&
              "undefined" !== typeof A[Q].label &&
              null !== A[Q].label &&
              0 < A[Q].label.toString().length &&
              (N = !0),
            (!N && "function" === typeof t.indexLabelFormatter) ||
              "function" === typeof A[Q].indexLabelFormatter)
          )
            N = !0;
        N =
          N ||
        ...
        ("inside" !== t.indexLabelPlacement && N) ||
          (D = (y.width - 0.75 * J) / 2);
        var Q = y.x1 + D,
          K = y.x2 - D,
          L = y.y1 + z,
        ...
        if (0 != t.length && t.dataPoints && t.visible && 0 !== A.length) {
          var ba, G;
          a = (75 * J) / 100;
          var T = (30 * (K - a)) / 100;
          "funnel" === t.type
            ? ((ba = r(t.options.neckHeight) ? 0.35 * E : t.neckHeight),
              (G = r(t.options.neckWidth) ? 0.25 * a : t.neckWidth),
          ...
          if (-1 !== Q) {
            if (t.reversed)
              for (J.push(Z), G = Q.length - 1; 0 < G; G--)
                (Z += Q[G]), J.push(Z);
            else for (G = 0; G < Q.length; G++) (Z += Q[G]), J.push(Z);
            if (t.reversed)
              for (G = 0; G < Q.length; G++)
                J[G] < ya
                  ? (a.push(M), D.push($), (ca = G))
                  : (a.push((J[G] - na + V * W) / V),
                    D.push((J[G] - na + ea * U) / ea));
            else
              for (G = 0; G < Q.length; G++)
                J[G] < ya
                  ? (a.push((J[G] - na + V * W) / V),
            ...
            for (G = 0; G < Q.length - 1; G++)
              (Z = t.reversed
                ? A[A.length - 1 - G].color
                  ? A[A.length - 1 - G].color
                  : t._colorSet[(A.length - 1 - G) % t._colorSet.length]
                : A[G].color
                ? A[G].color
            ...
            if (
              ...
              for (G = 0; G < R.length; G++)
                (R[G].x1 += B),
                  ...
                  (R[G].x3 += B),
                  (R[G].x4 += B),
                  R[G].x5 && ((R[G].x5 += B), (R[G].x6 += B)),
                  (H[G].textBlock.x += B);
            }
            for (G = 0; G < R.length; G++)
              (B = R[G]), pa(S, B, t.fillOpacity), ia.push(B.y1);
            v(S);
            N &&
              t.visible &&
              ("inside" === t.indexLabelPlacement || x.animationEnabled || n(S),
              x.animationEnabled || s());
            if (!N)
              for (G = 0; G < A.length; G++)
                (B = t.dataPointIds[G]),
                  (a = {
            ...
            this.funnelPyramidClickHandler = function (a) {
              ...
              if (
                ...
                if ("funnel" === t.type || "pyramid" === t.type)
                  t.reversed
                    ? (A[A.length - 1 - a].exploded = A[A.length - 1 - a]
                        .exploded
                        ? !1
                        : !0)
                    : (A[a].exploded = A[a].exploded ? !1 : !0);
                l(x, b, 500);
              }
            };
            return {
            ...
            for (var A = 0; A < p.dataPoints.length; A++) {
              var y = p.dataPoints[A],
                ...
                s = y.legendMarkerColor
                  ...
                  : p.color
                  ? p.color
                  : p._colorSet[A % p._colorSet.length],
                ...
                !a[g] ||
                  ...
                  0 < h
                    ...
                    : a[g].viewportMaximum === a[g].maximum &&
                      ...
                      (0 < I && (m += I), 0 < h && (l -= h))),
                n.panEnabled
                  ? (U = r(n.sessionVariables.axisX.height)
                ...
                d[g]._labels &&
                  ...
                  (t =
                    ...
                    (h.textBlock.height - h.textBlock.fontSize / 2) *
                      Math.sin((Math.PI / 180) * Math.abs(h.textBlock.angle)))),
                n.panEnabled
                  ? (V = r(n.sessionVariables.axisX2.height)
                      ? (n.sessionVariables.axisX2.height = V)
                      : n.sessionVariables.axisX2.height)
                  : (n.sessionVariables.axisX2.height = V),
                (h = Math.round(f.y1)),
                (k = d[g].lineCoordinates.y1 = h + V + W - Y),
              ...
              b[g] &&
                ...
                (M =
                  b[g]._labels && 0 < b[g]._labels.length
                    ...
                    : 0),
                (h = Math.round(
                  f.y1 + V + W < Math.max(M, p) ? Math.max(M, p) : f.y1 + V + W
                )),
                (M =
                  0 < a.length
                    ? 0
          ...
          if (c && 0 < c.length)
            for (g = 0; g < c.length; g++)
              (c[g].lineCoordinates = {}),
                ...
                (l = Math.round(
                  f.x2 - U - W > n.width - 10 ? n.width - 10 : f.x2 - U - W
                )),
                c[g].labelAutoFit &&
                  !r(x) &&
                  (0 < !a.length &&
            ...
            for (g = 0; g < d.length; g++) {
              ...
              if (b && 0 < b.length)
                for (M = 0; M < b.length; M++)
                  b[M] &&
                    b[M].labelAutoFit &&
                    ((l = b[M].lineCoordinates.x2), (m = l - U));
              d[g].lineCoordinates = {
                x1: l + S,
                y1: h,
                x2: l + S,
    ...
    D.prototype.calculateBreaksSizeInValues = function () {
      for (
        ...
        (e = b || !r(d[f].options.spacing)),
          (d[f].spacing =
            Ua(d[f].spacing, a, 8, e ? 0.1 * a : 8, e ? 0 : 3) << 0),
    ...
    D.prototype.calculateLogarithmicAxisParameters = function () {
      ...
      h = Math.pow(
        this.logarithmBase,
        D.getNiceNumber(Math.abs(Math.log(h) / d), !1)
      );
      this.options && 0 < this.options.interval
        ? (this.interval = this.options.interval)
        : ((this.interval = D.getNiceExponent(Math.log(h) / d / (a - 1), !0)),
      ...
      if (this.snapToDataPoint) {
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
          ...
          if (
            ...
            for (
              var v = Math.abs(
                  a - this.parent.convertValueToPixel(n[x].dataPoint.y[0])
                ),
                t = 0,
                s = 0;
              s < n.length;
              ...
              if (n[s].dataPoint.y && n[s].dataPoint.y.length)
                for (var A = 0; A < n[s].dataPoint.y.length; A++)
                  (t = Math.abs(
                    a - this.parent.convertValueToPixel(n[s].dataPoint.y[A])
                  )),
                    t < v && ((v = t), (x = s));
              else
                (t = Math.abs(
            ...
            for (
              ...
              if (n[s].dataPoint.y && n[s].dataPoint.y.length)
                for (A = 0; A < n[s].dataPoint.y.length; A++)
                  (t = Math.abs(
                    a - this.parent.convertValueToPixel(n[s].dataPoint.y[A])
                  )),
                    t < v && ((v = t), (x = s));
              ...
              if (n[s].dataPoint.y && n[s].dataPoint.y.length)
                ...
                (y += n[s].dataPoint.y),
                  (z = n[s].dataPoint.x.getTime
                    ...
                    : n[s].dataPoint.x),
                  (z = 100 * (y / n[s].dataSeries.plotUnit.dataPointYSums[z])),
          ...
          if (
            ...
            if (
              ...
              v = Math.abs(
                a - this.parent.convertValueToPixel(A.dataPoint.y[0])
              );
              for (s = t = 0; s < A.dataPoint.y.length; s++)
                (t = Math.abs(
                  a - this.parent.convertValueToPixel(A.dataPoint.y[s])
                )),
                  t < v && ((v = t), (b = s));
              l =
                1 === q.lineWidth % 2
                  ? (this.parent.convertValueToPixel(A.dataPoint.y[b]) << 0) +
                    0.5
                  : this.parent.convertValueToPixel(A.dataPoint.y[b]) << 0;
              ...
              (l =
                1 === q.lineWidth % 2
                  ? (this.parent.convertValueToPixel(A.dataPoint.y) << 0) + 0.5
                  : this.parent.convertValueToPixel(A.dataPoint.y) << 0),
                (this.value = A.dataPoint.y),
                (k.text = this.labelFormatter
                  ? this.labelFormatter({
                      chart: this.chart,
                      axis: this.parent.options,
            ...
            f =
              ...
              w =
                1 === q.lineWidth % 2
                  ? (this.parent.convertValueToPixel(A.dataPoint.x) << 0) + 0.5
                  : this.parent.convertValueToPixel(A.dataPoint.x) << 0;
            b = this.chart.plotArea.x1;
          ...
          if (z) {
            if ("axisX" === this.parent.type)
              for (
                s = this.parent.convertPixelToValue({ x: a }), v = null, x = 0;
                x < this.parent.dataSeries.length;
                x++
              )
                (v = this.parent.dataSeries[x].getDataPointAtX(s, !0)) &&
          ...
          if (
            ...
            for (
              ...
              if (n[s].dataPoint.y && n[s].dataPoint.y.length)
                for (A = 0; A < n[s].dataPoint.y.length; A++)
                  (t = Math.abs(
                    d - this.parent.convertValueToPixel(n[s].dataPoint.y[A])
                  )),
                    t < v && ((v = t), (x = s));
              else
                (t = Math.abs(
          ...
          if (
            ...
            v = Math.abs(d - this.parent.convertValueToPixel(A.dataPoint.y[0]));
            for (s = t = 0; s < A.dataPoint.y.length; s++)
              (t = Math.abs(
                d - this.parent.convertValueToPixel(A.dataPoint.y[s])
              )),
                t < v && ((v = t), (b = s));
            w =
              1 === q.lineWidth % 2
                ? (this.parent.convertValueToPixel(A.dataPoint.y[b]) << 0) + 0.5
                : this.parent.convertValueToPixel(A.dataPoint.y[b]) << 0;
            k.text = this.labelFormatter
              ? this.labelFormatter({
                  chart: this.chart,
              ...
              ? ((w =
                  1 === q.lineWidth % 2
                    ? (this.parent.convertValueToPixel(
                        A.dataSeries.dataPointEOs[A.index].cumulativeSum
                      ) <<
                        0) +
                      0.5
                    : this.parent.convertValueToPixel(
                ...
                (k.text = this.labelFormatter
                  ...
                  : this.label),
                (this.value = A.dataSeries.dataPointEOs[A.index].cumulativeSum))
              : ((w =
                  1 === q.lineWidth % 2
                    ? (r(a)
                        ? d
      ...
      if (!this.chart.disableToolTip) {
        ...
        if (
          ...
          if ((b = this.chart.getDataPointAtXY(a, d, c)))
            ...
            if (
              ((b = ab(a, d, this.chart._eventManager.ghostCtx)),
              0 < b &&
