                ...
                <form class="needs-validation" id="myForm" method="post" enctype="multipart/form-data"
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-7">
                            <div class="row">
                                <div class="col-md-4">
                                    <img id="previewGambar" src="" alt="Preview Gambar" class="img-fluid">
                                </div>
                            </div>
                        </div>
                    </div>
...
?>
    ...
    //untuk mengenable no id
    function enableNoIdField() {
        const jenisId = document.getElementById('jenis_id').value;
        const noIdField = document.getElementById('no_id');
        noIdField.disabled = jenisId === '';
        noIdField.value = '';
    }
    ...
    function enableNoIdField() {
        ...
        switch (jenisId) {
            ...
            case 'ID_TESEDIA':
                ...
                break;
            default:
                noIdField.maxLength = 20; // Set a default maximum length if jenis_id is not recognized
                break;
        }

        // Enable 'no_id' field and reset its value
        noIdField.disabled = jenisId === '';
        noIdField.value = '';
